...
- QA idle observation: the scheduler table stayed at 197 total historical rows with exactly 8 legitimate future matchroom jobs pending and zero cron jobs; no new push or maintenance work appeared. Full active-journey usage testing is still open.
