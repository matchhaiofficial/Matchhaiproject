...
exports.blockUser = exports.removeFriend = exports.respondFriendRequest = exports.sendFriendRequest = void 0;
...
exports.sendFriendRequest = functions.https.onCall(async (data, context) => {
    ...
    await db.collection('notifications').add({
        type: 'friend_request',
        fromUid: fromUid,
        fromUsername: (fromData === null || fromData === void 0 ? void 0 : fromData.username) || 'Unknown',
        toUid: toUid,
        status: 'pending',
        createdAt: now,
        expiresAt: expiresAt,
...
exports.respondFriendRequest = functions.https.onCall(async (data, context) => {
    ...
    await db.runTransaction(async (t) => {
        ...
        if (decision === 'accept') {
            ...
            const meUsername = ((_a = meSnap.data()) === null || _a === void 0 ? void 0 : _a.username) || 'Unknown';
            const senderUsername = ((_b = senderSnap.data()) === null || _b === void 0 ? void 0 : _b.username) || notif.fromUsername || 'Unknown';
            const now = admin.firestore.Timestamp.now();
            // Add A->B
